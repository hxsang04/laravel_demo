                                ...
                                <div class="cart-hover">
                                    <div class="select-items">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td class="si-pic"><img src="./frontend/assets/img/select-product-1.jpg" alt=""></td>
                                                    <td class="si-text">
                                                ...
                                                <tr>
                                                    <td class="si-pic"><img src="./frontend/assets/img/select-product-2.jpg" alt=""></td>
                                                    <td class="si-text">
                                                        <div class="product-selected">
                                                            <p>$60.00 x 1</p>
                                                            <h6>Kabino Bedside Table</h6>
            ...
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        ...
                        <li><a href="{{ route('orderHistory')}}">Đơn hàng đã mua</a></li>
                    </ul>
                </nav>
